<?php for ($i = 0; $i <= 3; $i++): ?>
	<article>
		...
		<div class="article-text">
			<figure>
				<img src="img/paisagem.jpg" title="Paisagem" alt="Árvores ao redor de um lago no outono">
		...
		<div class="article-comments">
			<input class="show-comments" type="button" value="Comentar/Exibir comentários">			
			<form>
				<fieldset>
